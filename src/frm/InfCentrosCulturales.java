 ...
 * @author Usuario
 */
public class InfCentrosCulturales extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(InfCentrosCulturales.class.getName());

    /**
     * Creates new form InfCentrosCulturales
     */
    public InfCentrosCulturales() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Descubre varias edificaciones y sitios en Cuenca que la ayudarón a convertirse en Patrimonio Cultural de la Humanidad, varios de ellos albergan ");
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 120, 760, -1));

        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setText("diferentes expresiones de artes visuales, plásticas, teatrales, entre otras.");
        ...
        jLabel5.setText("Centros culturales");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 80, -1, -1));

        jButton1.setFont(new java.awt.Font("Segoe UI Black", 1, 14)); // NOI18N
        jButton1.setText("Lista de Centros Culturales");
        jButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton1ActionPerformed(evt);
            }
        });
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 400, -1, 50));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        HorariosCentrosCulturales horcultura = new HorariosCentrosCulturales();
        horcultura.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new InfCentrosCulturales().setVisible(true));
    }
