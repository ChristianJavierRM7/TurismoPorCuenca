 ...
 * @author Usuario
 */
public class CultureTrip5 extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(CultureTrip5.class.getName());

    /**
     * Creates new form CultureTrip5
     */
    public CultureTrip5() {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnVFamilia2.setText("<html>Jueves de Compadres y Comadres<br><small></small></html>");
        btnVFamilia2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnVFamilia2ActionPerformed(evt);
            }
        });
        jPanel2.add(btnVFamilia2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 130, 160, 100));

        btnVFamilia5.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        btnVFamilia5.setText("<html>Artesanos y museos<br><small></small></html>");
        btnVFamilia5.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnVFamilia5ActionPerformed(evt);
            }
        });
        jPanel2.add(btnVFamilia5, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 120, 190, 110));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new CultureTrip5().setVisible(true));
    }
