...
public class Frm_map extends javax.swing.JFrame {
    ...
    public Frm_map() {
        ...
        // 🖱️ 6. Habilitar zoom y arrastre
        MouseInputListener mia = new PanMouseInputListener(mapViewer);
        mapViewer.addMouseListener(mia);
        mapViewer.addMouseMotionListener(mia);
        mapViewer.addMouseWheelListener(new ZoomMouseWheelListenerCenter(mapViewer));

        // 🖱️ 7. Clic para obtener coordenadas
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Centro Historico de Cuenca", "Catedral Inmaculada Concepcion", "Parque Calderón", "Museo Pumapungo", "Parque San Blas" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (opc >= 0 && opc < items.length) {
            ...
            if (coords != null) {
                ...
                System.out.println("Coordenadas extraídas:");
